...
if ENV:
    ...
    START_IMG = os.environ.get("START_IMG", "https://telegra.ph//file/3fc07f0eb7e0784d4a880.jpg")
    ASS_USERNAME = os.environ.get("ASS_USERNAME", "")
    BOT_TUT = os.environ.get("BOT_TUT", "https://telegra.ph/file/48354456ad6388d66b0b2.mp4")
    MUSICBOT_TUT = os.environ.get("MUSICBOT_TUT", "https://telegra.ph/file/48354456ad6388d66b0b2.mp4")
    PORT = int(os.environ.get("PORT", 5000))
    CERT_PATH = os.environ.get("CERT_PATH")
    API_ID = os.environ.get("API_ID", None)
    API_HASH = os.environ.get("API_HASH", None)
    DB_URI = os.environ.get("DATABASE_URL")
    UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "GIRLSSAFEZONE")
